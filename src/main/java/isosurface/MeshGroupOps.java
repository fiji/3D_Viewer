...
public class MeshGroupOps extends ContentNode {
	...
	public MeshGroupOps(final Content c) {
		this(c.getCurrent());
	}

	public MeshGroupOps(final ContentInstant c) {
		super();
		this.c = c;
		Color3f color = c.getColor();
		final List tri =
			((MCTriangulator) triangulator).getTrianglesOps(c.getImage(), c.getThreshold(),
