...
class Utils {
	 ...
	 * given array as possible according to the desired new length. If the new
	 * length is shorter that a.length, it will shrink and crop from the end; if
	 * larger, the extra spaces will be set with zeros.
	 */
